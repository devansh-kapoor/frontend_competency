  ...
  return (
    <Grid container direction='column' >
      <footer style={{ backgroundColor: '#2A2E3A' }}>
        <Paper variant='outlined' sx={{ backgroundColor: '#2A2E3A', marginLeft: "220.5px", marginRight: "82px", marginBottom: '58px', border: 'none'}}>
          <Box p={4} paddingBottom={6}  >
            ...
            <Grid container direction='row' sx={{ marginTop: '40.27px' }} spacing={{xs:5,sm:3,md:5}}>
              <Grid item  container direction='column' xs={12} sm={6} md={6} lg={3} >
                <Box paddingBottom={1}>
                  <Typography
                    variant='h5'
                    sx={{
