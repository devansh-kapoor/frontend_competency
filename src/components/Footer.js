...
export default function Footer() {
  return (
    <Grid container direction='column' >
      <footer style={{ display:'flex', justifyContent:'center', backgroundColor: '#2A2E3A' }}>
        <Paper variant='outlined' sx={{ backgroundColor: '#2A2E3A', marginBottom: '58px', border: 'none'}}>
          <Box p={4} paddingBottom={6}  >
            <svg width="72" height="72" style={{marginBottom:'10px'}} viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Grid container direction='row' sx={{ marginTop: '40.27px' }} spacing={{xs:5,sm:3,md:10}} columnSpacing={{lg:23}}>
              <Grid item  container direction='column' xs={6} sm={3} md={3} lg={3} >
                <Box paddingBottom={1}>
                  <Typography
                    variant='h5'
                    sx={{
              ...
              <Grid item xs={6} sm={3} md={3} lg={3} container direction='column'>
                <Box paddingBottom={1}>
                  <Typography
                    variant='h5'
                    sx={{
          ...
          <div className='separator' style={{ color: "white", width: "100%", left: '0rem', position: 'relative', borderTop: "solid 1px" }}></div>
          <Box p={4} paddingBottom="24px" sx={{ width: '100%' }}>
            <Grid container direction='row'>
              <Grid item xs container direction='column' >
                <Box paddingBottom={2} paddingTop={2}>
                  <Grid container spacing={11.5}>
                    <Grid item>
                    <img
                      style={{ height: "78px" }}
